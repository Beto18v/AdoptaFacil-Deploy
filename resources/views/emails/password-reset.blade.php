                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px; background:#ffffff; border-radius:8px; padding:24px;">
                    ...
                    <tr>
                        <td style="font-size:16px; line-height:1.6; padding-bottom:16px;">
                            Haz clic en el siguiente botón para crear una nueva contraseña. Este enlace expirará en 60 minutos.
                        </td>
                    </tr>
                    <tr>
                        <td align="center" style="padding-top:8px; padding-bottom:20px;">
                            <a href="{{ $resetUrl }}" style="display:inline-block; background:#2563eb; color:#ffffff; text-decoration:none; font-size:16px; font-weight:600; padding:12px 20px; border-radius:6px;">
                                Restablecer contraseña
                            </a>
                        </td>
                    </tr>
                    <tr>
                        <td style="background:#f3f4f6; border-radius:6px; padding:12px 16px; font-size:14px; line-height:1.6; color:#374151;">
