import{r as g,j as e}from"./app-ClXkJIb2.js";import{L as p,I as m}from"./label-ZRsuHCPy.js";import{B as v}from"./badge-B1Q9FY3i.js";import{B as b}from"./button-DHxI3hVK.js";import{D as j,b as w,c as N,d as E,e as C}from"./dialog-NCWh5nwu.js";import{I as z}from"./input-uLPgqf-7.js";import{T as D}from"./textarea-CXjdGUSt.js";import"./index-ChRPiN-n.js";import"./index-BImfiMj1.js";import"./Combination-CWE6QbYj.js";import"./index-B3GQEovv.js";import"./x-DT7w2hwT.js";import"./createLucideIcon-BrtItOiz.js";const y=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$=(a,s)=>{const d=typeof window>"u"?"https://adoptafacil.com":window.location.origin,r=y(a.trim()||"Asunto del correo"),i=y(s.trim()||"Escribe aqui el mensaje que quieres enviar a los usuarios seleccionados.").replace(/\n/g,"<br>");return`
        <!doctype html>
        <html lang="es">
        <head>
            <meta charset="UTF-8">
