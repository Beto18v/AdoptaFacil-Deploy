import{r as g,j as e}from"./app-B0Nd2b1_.js";import{L as p,I as m}from"./label-CLY9XLwV.js";import{B as v}from"./badge-B7UJ5cBD.js";import{B as b}from"./button-CDY0XIyU.js";import{D as j,b as w,c as N,d as E,e as C}from"./dialog-dcL5w2-7.js";import{I as z}from"./input-CO2ewCyC.js";import{T as D}from"./textarea-x5vcejjl.js";import"./index-BSLXbvPv.js";import"./index-DGdvZkaP.js";import"./index-CYoB8bal.js";import"./index-DJhUxjEB.js";import"./x-DVGg4XoS.js";import"./createLucideIcon-CnAs1iCa.js";const y=a=>a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),$=(a,s)=>{const d=typeof window>"u"?"https://adoptafacil.com":window.location.origin,r=y(a.trim()||"Asunto del correo"),i=y(s.trim()||"Escribe aqui el mensaje que quieres enviar a los usuarios seleccionados.").replace(/\n/g,"<br>");return`
        <!doctype html>
        <html lang="es">
        <head>
            <meta charset="UTF-8">
